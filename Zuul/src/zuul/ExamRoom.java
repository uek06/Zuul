	...
	public void action(Student s) {
    	...
    	if ("".equals(course.getName())) {
    		...
    		if (!(s.aSuiviTousLesCoursEtTD(course) || (s.getLivrePOOLu && "POO".equals(course.getName())))) {
				...
				System.out.println("Vous devez en avoir suivi au minimum "+cours.getNombreMiniCoursExam());
			}
				...
				System.out.println("L'energie minimale pour passer un examen est de "+s.SANTEMINPOURTEST);
